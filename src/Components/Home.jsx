      ...
      <div className="home-container mt-[1px] ">
        <div className="relative">
          ...
          <div className="absolute inset-0 left-1/2 top-1/3 text-white text-center ">
            <h1 className="sm:text-5xl font-bold mb-2 text-crimsonRed text-xl pr-1">
              Welcome to Ice-fy Delight.
            </h1>
            <h6 className="sm:text-base text-red-700 text-sm">
              The best ice cream in town with a variety of flavors to choose
              from!
            </h6>
          </div>
        </div>
